      ...
      <div className="flex items-center gap-3.5 px-6 py-3.5 rounded-2xl bg-slate-800/80 border border-slate-700/60 shadow-2xl shadow-teal-500/10 backdrop-blur-md">
        ...
        <div className="flex items-center text-sm font-semibold text-slate-200 tracking-wide">
          ...
          <span className="inline-flex ml-1 space-x-0.5">
            <span className="animate-[bounce_1s_infinite_100ms] text-teal-400">.</span>
            <span className="animate-[bounce_1s_infinite_200ms] text-teal-400">.</span>
            <span className="animate-[bounce_1s_infinite_300ms] text-teal-400">.</span>
          </span>
        </div>
